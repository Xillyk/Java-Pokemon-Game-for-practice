...
public class GameAction {
    ...
    private void createNewPokemonUI() {
        System.out.println("============================================================");
    ...
    private void showPlayPokemonWorldUI() {
        System.out.println("============================================================");
    ...
    private void showPokemonStatusUI() {
    ...
    private void curePokemonAtPokemonCenter() {
        System.out.println("============================================================");
    ...
    /*
        private int findIndexOfArrayList() {
            int index = 0;
            for (Pokemon mypokemon : myPokemons) {
                if()
            }
    ...
    */
        ...
        private void delay(int _delayInMicrosec) {
            try {
